...
class HANClassifier(nn.Module):
    ...
    """
    def __init__(self, num_classes=6, vocab_size=30000, embed_dim=768, word_gru_hidden_dim=768, sent_gru_hidden_dim=768,
                word_gru_num_layers=2, sent_gru_num_layers=2, word_att_dim=768, sent_att_dim=768, use_layer_norm=False, dropout=0.10):
        """
